		...
		<template v-slot:top>
			<v-toolbar flat>
							...
							<v-container>
								<v-row>
									<v-col cols="12" sm="6" md="12">
										<v-text-field v-model="editedItem.tipo" label="Tipo de Usuario"></v-text-field>
									</v-col>
								</v-row>
							</v-container>
						</v-card-text>
				...
				<v-dialog v-model="dialogDelete" max-width="550px">
					<v-card>
						<v-card-title class="text-h5">Estas seguro de eliminar el tipo de usuario?</v-card-title>
						<v-card-actions>
							<v-spacer></v-spacer>
